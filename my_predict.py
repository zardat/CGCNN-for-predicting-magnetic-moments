...
from cgcnn.data1 import CIFData
from cgcnn.data1 import collate_pool
...
def validate(val_loader, model, criterion, normalizer, test=False):
    ...
    if test and model_args.task == 'regression':
...
# Set title with increased font size
    plt.title('Predicting V FM  ', fontsize=15)  # Increased font size
...
# Save the figure in high quality (consider saving as SVG)
    plt.savefig('DST3-pred_v_fm.png', dpi=300)
